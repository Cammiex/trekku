  ...
  return (
    ...
    >
      ...
      <div id="destination-card-list" className="flex flex-wrap gap-8">
        <div
          id="destination-item"
          className="relative w-[260px] h-[332px] rounded-[20px] flex flex-col justify-end shadow-cardShadow bg-cover overflow-hidden group group-hover:shadow-lg cursor-pointer active:scale-105 transition"
        >
