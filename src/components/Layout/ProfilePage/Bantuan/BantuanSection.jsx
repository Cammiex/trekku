...
const AccordionSection = () => {
  return (
    <div className="w-[716px] h-fit bg-white flex flex-col items-center rounded-2xl text-black overflow-y-scroll no-scrollbar">
      {' '}
      <Tabs
...
const BantuanSection = () => {
  return (
    <section className="w-[797px] h-[630px] rounded-2xl bg-white shadow-cardShadow pl-10 pr-7 pt-8 text-black flex flex-col">
      <h1 className="font-semibold text-[24px]">Bantuan</h1>
      <div className="flex flex-col gap-5 mt-10">
        <div className="flex flex-col">
          <h1 className="font-semibold text-primary-80">Tanya apapun</h1>
          <p className="text-[14px] font-medium text-neutral-70">
            Apakah ada pertanyaan? Kami disini akan membantumu.
          </p>
        </div>
        <div className="relative">
          <FontAwesomeIcon
            icon={faSearch}
            className="text-[#53686A] size-[14px] absolute top-[9.5px] left-4"
          />
          <input
            type="text"
            name=""
            id=""
            className="w-[332px] h-[34px] rounded-lg bg-white shadow-inputShadow border-none ring-0 pl-10 text-[12px]"
